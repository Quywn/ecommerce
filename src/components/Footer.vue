  ...
  <footer>
    <div class="footer-container">
      <div class="footer-section">
        <h3>Giới thiệu</h3>
        <p>
          Chúng tôi chuyên cung cấp các loại bánh ngọt, bánh mặn tươi ngon, được
      ...
      <div class="footer-section">
        ...
        <ul>
          ...
          <li>
            ...
            ><i class="fab fa-shopify"></i> Shopee</a
            >
          </li>
        </ul>
      </div>
    ...
    <p class="footer-bottom">
      &copy; 2025 Cửa hàng Bánh Online - Hotline: 0xx.xxx.xxx
    </p>
  </footer>
</template>
